...
STATICFILES_STORAGE = "whitenoise.storage.CompressedManifestStaticFilesStorage" ##for enabling whitenoise compression
...
#FRONTEND_SITE_URL = env("STRIPE_SECRET_KEY")
